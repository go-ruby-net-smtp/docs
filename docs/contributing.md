...
Contributions are welcome. `go-ruby-net-smtp/net-smtp` is built to a small set of
...
The library is in [`github.com/go-ruby-net-smtp/net-smtp`](https://github.com/go-ruby-net-smtp/net-smtp).
This documentation site is in [`github.com/go-ruby-net-smtp/docs`](https://github.com/go-ruby-net-smtp/docs).
