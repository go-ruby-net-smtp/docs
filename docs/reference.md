...
The public API lives at the module root (`github.com/go-ruby-net-smtp/net-smtp`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `net-smtp`, while the surface follows
...
```go
import "github.com/go-ruby-net-smtp/net-smtp"
```
...
- **[pkg.go.dev/github.com/go-ruby-net-smtp/net-smtp](https://pkg.go.dev/github.com/go-ruby-net-smtp/net-smtp)**

The module's [README](https://github.com/go-ruby-net-smtp/net-smtp#readme) carries worked
