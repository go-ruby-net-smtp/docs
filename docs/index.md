# go-ruby-net-smtp documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-smtp (no cgo)**

`go-ruby-net-smtp/net-smtp` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-smtp`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-smtp/net-smtp`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-smtp`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`net-smtp`](https://github.com/go-ruby-net-smtp/net-smtp) | the library — Ruby's `net-smtp` in pure Go |
| [`docs`](https://github.com/go-ruby-net-smtp/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-smtp.github.io`](https://github.com/go-ruby-net-smtp/go-ruby-net-smtp.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-smtp/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-smtp/net-smtp](https://github.com/go-ruby-net-smtp/net-smtp).
