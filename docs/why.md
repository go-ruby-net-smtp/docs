...
`go-ruby-net-smtp/net-smtp` reimplements Ruby's `net-smtp` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-smtp/net-smtp` directly, with no Ruby runtime;
